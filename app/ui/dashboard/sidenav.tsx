    ...
    <div className="flex h-full flex-col px-3 py-4 md:px-2 bg-[#0b0b09] border-r-3 border-[#6acb8c] rounded-br-xl">
      ...
      <div className="flex grow flex-row justify-between space-x-2 md:flex-col md:space-x-0 md:space-y-2">
        ...
        <form action = {async () => {
          ...
          <button className="flex h-[48px] w-full grow items-center justify-center gap-2 rounded-md bg-[#161612] p-3 text-sm font-medium hover:bg-[#73746B] hover:text-[#F5F5F5] md:flex-none md:justify-start md:p-2 md:px-3">
